...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.daterangepicker')
            .on('update', $.proxy(this.updateAll, this));
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.locale === 'object') {
                ...
                if (Object.prototype.toString.call(options.locale.weekendDays) === '[object Array]') {
                    var self = this;
                    this.locale.weekendDays = [];
                    $.each(options.locale.weekendDays, function (index, weekend) {
                        if (typeof weekend === 'number') {
                            self.locale.weekendDays.push(weekend);
                        }
                    });
                }
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            $.each(this.locale.daysOfWeek, function (index, dayOfWeek) {
                ...
                var dayOfWeekHtml = '<th>' + dayOfWeek + '</th>';
                if ($.inArray(index, self.locale.weekendDays) > -1) {
                    // weekends
                    dayOfWeekHtml = '<th class="weekend">' + dayOfWeek + '</th>';
                }
                html += dayOfWeekHtml;
            });
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    var cname = 'available ';
                    if ($.inArray(col, self.locale.weekendDays) > -1) {
                        cname += 'weekend ';
                    }
