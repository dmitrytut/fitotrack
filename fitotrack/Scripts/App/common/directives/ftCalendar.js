 ...
 * ftCalendar.js
 * Calendar directive.
 * @param selected - momentjs date object or timestamp ('isTimestamp' must be 'true').
 * @param isTimestamp - flag that 'selected' parameter is timestamp.
